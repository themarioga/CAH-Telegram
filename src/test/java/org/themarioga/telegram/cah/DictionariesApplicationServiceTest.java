...
class DictionariesApplicationServiceTest {
    ...
    private static final Set<String> COMMANDS = Set.of(
            ...
            "/change_lang", "/delete_select", "/delete", "/toggle_select", "/share_select",
            "/manage_cards_select", "/add_white_card", "/edit_white_card_sel", "/edit_white_card",
            "/delete_white_card", "/add_black_card", "/edit_black_card_sel", "/edit_black_card",
            "/delete_black_card", "/manage_collabs_select", "/add_collab", "/delete_collab",
            "/toggle_collab", "/getmyid", "/help");

    private static final Set<String> CALLBACKS = Set.of(
            "change_user_lang", "menu", "dictionary_list", "dictionary_create", "dictionary_rename",
            "dictionary_lang", "dictionary_delete", "dictionary_toggle", "dictionary_share",
            "share_accept", "share_decline", "dictionary_manage_cards", "manage_cards_select",
            "list_white_cards", "add_white_cards", "edit_white_cards", "delete_white_cards",
            "list_black_cards", "add_black_cards", "edit_black_cards", "delete_black_cards",
            "dictionary_manage_collabs", "manage_collabs_select", "list_collabs", "add_collabs",
            "delete_collabs", "toggle_collabs", "collaborator_accept", "collaborator_decline");
