...
public class ErrorMessageResolver {
    ...
    private static final Map<ErrorEnum, String> EXCEPTIONS_TO_CONVENTION = Map.of(
            CAHErrorEnum.DICTIONARY_COLLAB_ALREADY_EXISTS, "COLLABORATOR_ADD_ALREADY_EXISTS", CAHErrorEnum.DICTIONARY_COLLAB_NOT_FOUND, "ERROR_COLLABORATOR_DOESNT_EXISTS", CAHErrorEnum.DICTIONARY_MAX_COLLABORATORS_REACHED, "COLLABORATOR_ADD_MAX_REACHED", CAHErrorEnum.CARD_TEXT_TOO_LONG, "ERROR_CARD_EXCEEDED_LENGTH", CAHErrorEnum.CARD_NOT_FOUND, "ERROR_CARD_DOESNT_EXISTS", CAHErrorEnum.CARD_ALREADY_EXISTS, "ERROR_CARD_ALREADY_EXISTS", CommonErrorEnum.USER_NOT_FOUND, "ERROR_GAME_USER_DOESNT_EXISTS", CommonErrorEnum.ROOM_NOT_FOUND, "ERROR_GAME_ROOM_DOESNT_EXISTS");
